...
const I18N = {
  en: {
    ...
    'f-reset': 'Reset',
    'nav-news': 'News',
    'news-kicker': 'Marine Salvage News',
    'news-title': 'Industry News',
    'news-sub': 'Latest headlines on salvage, wrecks and maritime safety — refreshed daily from public feeds.',
  ...
  ru: {
    ...
    'f-reset': 'Сбросить',
    'nav-news': 'Новости',
    'news-kicker': 'Новости морского спасения',
    'news-title': 'Новости отрасли',
    'news-sub': 'Последние заголовки о спасении судов, крушениях и морской безопасности — обновляется ежедневно из открытых лент.',
